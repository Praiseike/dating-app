import { onboardingPreferences } from "@/constants/data";
...
const Badge: React.FC<BadgeProps> = ({
	...
	>
		<Text
			style={[styles.badgeText, { color: isSelected ? "white" : "gray" }]}
		>
			{item}
		</Text>
	</TouchableOpacity>
		...
		<SafeAreaView style={styles.container}>
			...
			>
				...
				>
					<Image
						source={{
							// uri: "",
              uri : "https://static.vecteezy.com/system/resources/previews/002/697/055/non_2x/red-heart-love-romantic-icon-free-vector.jpg"
						}}
						style={{
							width: "100%",
							height: "100%",
				...
				{onboardingPreferences.map((preference, index) => (
					<BadgeSection
						...
						isLastSection={
							index === onboardingPreferences.length - 1
						}
					/>
				))}
			</ScrollView>
			...
			<View style={styles.actionsContainer}>
				<View style={styles.actionButtonWrapper}>
					...
					>
						<Text
							style={[styles.likeButtonText, { color: "black" }]}
						>
							Back
						</Text>
					</TouchableOpacity>
				...
				<View style={styles.actionButtonWrapper}>
					<TouchableOpacity
						onPress={() => router.navigate("/(tabs)/pricing")}
