...
const CreditCard: React.FC<CreditCardProps> = ({ cardNumber, holderName, expiryDate, cardType }) => {
  ...
  return (
    <View style={[styles.creditCard, { backgroundColor: getCardGradient()[0] }]}>
      {/* Background gradient effect */}
      <View style={[styles.cardGradient, { backgroundColor: getCardGradient()[1] }]} />
      ...
      <View style={styles.cardFooter}>
        <View style={styles.cardDetail}>
          ...
          <Text style={styles.cardValue}>{holderName.toUpperCase() || 'HOLDER NAME'}</Text>
        </View>
        <View style={styles.cardDetail}>
        ...
        >
          ...
          <View style={styles.formContainer}>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={[styles.inputContainer, focusedField === 'cardNumber' && styles.inputFocused]}>
                <TextInput
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={[styles.inputContainer, focusedField === 'holderName' && styles.inputFocused]}>
                <TextInput
                  style={styles.textInput}
            ...
            <View style={styles.rowContainer}>
              <View style={[styles.inputGroup, styles.halfWidth]}>
                ...
                <View style={[styles.inputContainer, focusedField === 'expiryDate' && styles.inputFocused]}>
                  <TextInput
                    style={styles.textInput}
                    placeholder="MM/YY"
              ...
              <View style={[styles.inputGroup, styles.halfWidth]}>
                ...
                <View style={[styles.inputContainer, focusedField === 'cvc' && styles.inputFocused]}>
                  <TextInput
                    style={styles.textInput}
                    placeholder="123"
                    value={formData.cvc}
